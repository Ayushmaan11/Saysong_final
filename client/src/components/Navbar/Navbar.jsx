      ...
      <div className="container">
        <div className="logo">
          <Link to="/" className="link">
            <span onClick={()=> scrollToTop()} className="text">SaySong</span>
          </Link>
        ...
        <div className="links">
          <div className="menu-links">
            <span onClick={() => scrollToSection('business')}>Business</span>
            <span onClick={() => scrollToSection('explore')}>Explore</span>
            {!user?.isSeller && <Link className="link" to="/register">Become an Artist</Link>}
          </div>
          {isLoading ? (
            <Loader size={35} />
          ) : (
